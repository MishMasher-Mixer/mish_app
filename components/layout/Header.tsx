                ...
                <nav className='flex items-center justify-between h-[78px]'>
                    ...
                    <Sheet open={isOpen} onOpenChange={setIsOpen}>
                        <SheetTrigger asChild>
                            <Button variant={"secondary"} className='sm:hidden px-0' size={"icon"}>
                                <Menu className='w-6 h-6' />
                            </Button>
                        </SheetTrigger>

                        <SheetContent side='right' className='max-w-xs'>
                            <div className='flex flex-col space-y-8 mt-8 p-10'>

                                <ul className='flex flex-col gap-4 text-sm font-mono font-normal uppercase'>
                                    <li>
                                        <Link href={"/"} className='flex items-center gap-1.5 hover:text-primary text-sm font-medium'>
                                            <span>Deposit</span>
                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
